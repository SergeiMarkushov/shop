package ru.gb.shop.catrs.configs;
...
import ru.gb.shop.catrs.properties.ProductServiceIntegrationProperties;
...
public class AppConfig {
    ...
    public WebClient productServiceWebClient() {
        ...
        return WebClient
                .builder().baseUrl(productServiceIntegrationProperties.getUrl())
